...
#define PROTOCOL_TYP 1 //tcp:0; udp:1
...
int main (int argc, char* argv[]) {
	...
	printf("-----------iterative connectionless(udp) server------------------\n");
	...
	*/
	...
	while (1) {
		...
		*/
		...
		int rx = recvfrom (server_sock,&tx_file_name,MAX_FILE_NAME_LEN,0,(struct sockaddr*) &client,&client_addrlen);//sizeof(rcd));
		...
		//int tx = sendfile (server_sock,tx_file_name,MAX_TX_SIZE);
